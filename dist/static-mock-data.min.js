 ...
 * @license MIT
 */
"use strict";function cloneJSON(e,r){var t=[];return e.forEach(function(e){var o={};t.push(o),Object.keys(e).forEach(function(t){"string"==typeof e[t]&&r.indexOf(t)>=0?o[t]=new Date(e[t]):o[t]=e[t]})}),t}function absolutePaths(e){return process.browser||e.forEach(function(e){e.portrait=path.resolve(__dirname,"..",e.portrait),e.thumbnail=path.resolve(__dirname,"..",e.thumbnail)}),e}var employees=require("../employees.json"),projects=require("../projects.json"),path=require("path");module.exports.employees=absolutePaths(cloneJSON(employees,["dob","hiredOn","terminatedOn"])),module.exports.projects=cloneJSON(projects,["startedOn","endedOn"]);
